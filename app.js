...
const corsOptions = {
  origin: ["https://s-m-l-l.netlify.app", "http://localhost:3000/","https://s-m-l-l-webservice.onrender.com","https://s-m-l-l-api.onrender.com"], // Include https://
...
const swaggerOptions = {
  definition: {
    ...
    servers: [
      {
        url: "https://s-m-l-l-api.onrender.com",
      },
    ],
  },
  apis: ["./routes/v1/*.js"],
